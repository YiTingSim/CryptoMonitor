Project Title: Cryptocurrency Price Monitoring System, Prediction and Portfolio Manager
Project Name: CryptoMonitor
...
3. How to Run:
i) Option A (Direct Execution): 
Simply double-click the `index.html` file to open it in your default web browser.
   
ii) Option B (Local Web Server - Recommended): 
